...
import {DEFAULT_OG_IMAGE, SITE_DESCRIPTION, SITE_TITLE, SITE_URL, absoluteUrl} from "@/lib/site";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {articles.length} articles on JavaScript, React, Node.js, and the infrastructure decisions that matter at
          production scale.
        </p>
      </div>
