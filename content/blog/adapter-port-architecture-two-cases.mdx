...
seoTitle: "Ports and Adapters (Hexagonal Architecture), Explained with Two Real Codebases"
date: "2026-05-28"
updated: "2026-05-30"
description: "A plain-English guide to ports and adapters (hexagonal architecture) in TypeScript, shown through a 30-file email provider swap and a six-week API delay turned into one-line changes."
tags:
...
ogImage: "/og/adapter-port-architecture.png"
ogImageAlt: "Adapter port architecture diagram showing business logic connected through ports to swappable provider adapters"
ogImageWidth: 1672
ogImageHeight: 941
status: "published"
type: "blog"
